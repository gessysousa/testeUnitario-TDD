...
namespace Alura.LeilaoOnline.Core
{
    ...
    public class Leilao
    {
        ...
        public void TerminaPregao()
        {
            ...
            {
                throw new InvalidOperationException("Não é possível terminar o leilao sem que o pregão tenha começado. Para isso, utilize o método IniciaPregao()");
            }

            Ganhador = _avaliador.Avalia(this); //Avaliador avalia o leilão
